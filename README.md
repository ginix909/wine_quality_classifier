...
Функциональность
	•	Анализ и обработка данных о химическом составе вина.
	•	Обучение модели классификации на основе данных о белом и красном вине.
	•	Оценка качества вина по шкале от 0 до 10.
...
Используемые технологии
    ...
    sklearn.metrics - оценка качества предсказаний
    StandardScaler - стандартизация данных
    OneHotEncoder - кодирование данных
    optuna - подбор наилучших гипер-параметров
